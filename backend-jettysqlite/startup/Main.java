...
public class Main extends ScriptableObject
{
    ...
    public static Context init(String args[]) {
        ...
        try {
            ...
            main.defineFunctionProperties(names, Main.class,
            ...
            Scriptable argsObj = cx.newArray(main, array);
            main.defineProperty("arguments", argsObj,
                                 ScriptableObject.DONTENUM);

//            main.processSource(cx, args.length == 0 ? null : args[0]);

java.lang.System.out.println("Main About to walk . ...");
walk(".");
java.lang.System.out.println("... Done walking");
            main.processSource(cx, "./build/script/jettysqlite.js");
        } finally {
//            Context.exit();
        }
                            ...
                            Object[] args, Function funObj)
    {
        ...
        for (int i = 0; i < args.length; i++) {
            main.processSource(cx, Context.toString(args[i]));
        }
    }
        ...
        if (filename == null) {
            ...
            do {
                ...
                try {
                    ...
                    System.err.println("js: " + e.toString());
                }
                if (quitting) {
